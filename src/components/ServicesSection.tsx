  ...
  return (
    <section id="services" className="relative py-32 bg-background overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative">
        {/* Section Header */}
        <AnimatedSection className="max-w-2xl mb-20" direction="up">
        ...
        <StaggerContainer className="grid md:grid-cols-2 lg:grid-cols-3 gap-6" staggerDelay={0.1}>
          {services.map((service) => (
            <StaggerItem key={service.title} direction="up">
              <div className="group relative p-8 bg-card-gradient rounded-2xl border border-border/50 hover:border-primary/50 transition-all duration-500 hover:-translate-y-2 cursor-pointer overflow-hidden h-full">
                {/* Hover glow effect */}
